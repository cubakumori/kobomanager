...
class ErrorResponse {
    ...
    private const CODES = [
        ...
        'TOTP_CHALLENGE_EXPIRED'        => [401, 'El inicio de sesión caducó; vuelve a introducir tus credenciales'],
        'TOTP_ENROLL_REQUIRED'          => [403, 'Esta instancia exige un segundo factor (2FA): actívalo en tu perfil para continuar'],
