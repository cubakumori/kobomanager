...
abstract class HttpTestCase extends TestCase
{
    ...
    protected function grant(int $userId, int $formId, bool $view = true, bool $edit = false, bool $validate = false, ?array $rowFilter = null, ?array $fieldFilter = null, bool $settings = false, bool $sample = false): void
    {
        DB::run(
            'INSERT INTO user_form_permissions (user_id, form_id, can_view, can_edit, can_validate, can_settings, can_sample, row_filter, field_filter)
             VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)',
            [$userId, $formId, $view ? 1 : 0, $edit ? 1 : 0, $validate ? 1 : 0, ($settings || $sample) ? 1 : 0, $sample ? 1 : 0,
