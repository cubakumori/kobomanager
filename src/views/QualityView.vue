  ...
  <div class="space-y-6">
    ...
    <template v-else-if="q">
      ...
      <div class="flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-slate-500">
        ...
        <!-- Alcance por estado de revisión: chip-botón transitorio que se cambia AQUÍ
             MISMO (como el denominador del panel de muestra); arranca en el ajuste
             global. El valor por defecto para todos se ajusta en Configuración →
             Paneles (sin enlace propio: el toggle es el control de esta vista). -->
        <button
          type="button"
